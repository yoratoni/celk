(module
 ...
 (func $src/assembly/src/helpers/storage/loadUint32BE (param $ptr i32) (param $offset i32) (result i32)
  local.get $ptr
  local.get $offset
  i32.const 2
  i32.shl
 ...
 (func $src/assembly/src/crypto/SHA256/SHA256_ENGINE~visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  local.get $1
  call $~lib/object/Object~visit
      ...
      block $~lib/array/Array<u32>
       block $src/assembly/src/helpers/memory/IsMemorySlotSection
        block $src/assembly/src/helpers/memory/IsMemorySlot
         ...
         local.get $0
         local.get $1
         call $src/assembly/src/crypto/SHA256/SHA256_ENGINE~visit
         return
        end
        local.get $0
        local.get $1

/**
 * Library for the CPU TypeScript implementation of the Elliptic Curve, SECP256K1, as defined in SEC 2.
 *
 * See "src/lib/crypto/CPU_SECP256K1.ts" for more information & credits.
 */
